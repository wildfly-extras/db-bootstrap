 ...
 */
public class DbBootstrapScanDetectorResourceDefinition extends PersistentResourceDefinition {
    static final DbBootstrapScanDetectorResourceDefinition INSTANCE = new DbBootstrapScanDetectorResourceDefinition();
    static final SimpleAttributeDefinition NAME = new SimpleAttributeDefinitionBuilder(DbBootstrapExtension.NAME_ATTR, ModelType.STRING, false).build();
    ...
    public Collection<AttributeDefinition> getAttributes() {
        return Arrays.asList(NAME, FILENAME, FILTER_ON_NAME);
    }
}
